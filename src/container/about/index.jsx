...
<br></br>
          ...
          I've honed my skills in Python, Java, HTML, CSS, Javascript.
          I prefer coding in Python and I'm eager to explore new technologies and improve my skills. </p>
...
<br></br>
          ...
          This exploration led me to specilize in Frontend, Databases and Software Engineering during my Master's at Portland State University. </p>

<br></br>
          <p>Beyond this productive stuff, you can find me drawing, hiking and experimenting with new food recipes.</p>

<br></br>
          <p>I'm currently exploring possible paths in Software Engineering, and Data Science. I'm working on different projects to further develop my skills. </p>

<br></br>
          <p>Feel free to connect with me out on LinkedIn or GitHub to view my projects.</p>
      </div>
    </div>
    </div>
  );
